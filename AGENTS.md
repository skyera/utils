...
1.  **Research & Think**: Analyze the request or review notes, explore the relevant parts of the codebase, and identify the root cause or the optimal design for the change.
